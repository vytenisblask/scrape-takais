      ...
      <Container maxW="container.xl" p={4}>
          <Box display={{ base: 'block', md: 'flex' }}>
              <VStack flex="1" p={4} spacing={4}>
                  ...
                  {hasBasicInfo() && (
                      <Box border="1px" borderColor="gray.300" p={4} borderRadius="md" overflowY="auto">
                          <Heading as="h4" size="md">Basic info:</Heading>
                  ...
                  {robotsTxt && (
                      <Box border="1px" borderColor="gray.300" p={4} borderRadius="md" overflowY="auto">
                          <Heading as="h4" size="md">Robots.txt content:</Heading>
                          <Divider my={2} />
...
{cssData}
      ...
      {error && <Text color="red" position="absolute" bottom={10} left={10}>{error}</Text>}
  </Container>
);
